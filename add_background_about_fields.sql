-- Add background_link, about, booking_integrated, and company_path fields to rental_companies table
-- Created: 2025-10-28
...
-- Add company_path column (TEXT)
ALTER TABLE rental_companies
ADD COLUMN IF NOT EXISTS company_path TEXT;
...
DO $$
BEGIN
    RAISE NOTICE 'Successfully added background_link, about, booking_integrated, and company_path fields to rental_companies table';
END $$;
